 ...
 *      1）Spring Async：
 *          {@link cn.iocoder.txgy.framework.quartz.config.TxgyAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 TxgySecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.iocoder.txgy.framework.tenant;
