...
import cn.iocoder.txgy.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.txgy.framework.mybatis.core.util.MyBatisUtils;
import cn.iocoder.txgy.framework.redis.config.TxgyCacheProperties;
import cn.iocoder.txgy.framework.security.core.service.SecurityFrameworkService;
import cn.iocoder.txgy.framework.tenant.core.aop.TenantIgnore;
import cn.iocoder.txgy.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.iocoder.txgy.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.iocoder.txgy.framework.tenant.core.job.TenantJobAspect;
import cn.iocoder.txgy.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.iocoder.txgy.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.iocoder.txgy.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.iocoder.txgy.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.iocoder.txgy.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.iocoder.txgy.framework.tenant.core.service.TenantFrameworkService;
import cn.iocoder.txgy.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.iocoder.txgy.framework.tenant.core.web.TenantContextWebFilter;
import cn.iocoder.txgy.framework.tenant.core.web.TenantVisitContextInterceptor;
import cn.iocoder.txgy.framework.web.config.WebProperties;
import cn.iocoder.txgy.framework.web.core.handler.GlobalExceptionHandler;
...
public class TxgyTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "cn.iocoder.txgy.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     TxgyCacheProperties txgyCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(txgyCacheProperties.getRedisScanBatchSize()));
