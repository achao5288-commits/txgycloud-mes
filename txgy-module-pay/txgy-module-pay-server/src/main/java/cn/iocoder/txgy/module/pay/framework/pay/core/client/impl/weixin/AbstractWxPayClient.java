package cn.iocoder.txgy.module.pay.framework.pay.core.client.impl.weixin;
...
import cn.iocoder.txgy.framework.common.util.io.FileUtils;
...
import static cn.iocoder.txgy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static cn.iocoder.txgy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/txgycode/txgy-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/txgy-cloud/issues/ICSFL6
