package cn.iocoder.txgy.module.hrm.service.performance.assessment;

import cn.iocoder.txgy.module.hrm.service.performance.plan.HrmPerformancePlanService;
import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.iocoder.txgy.framework.common.pojo.PageResult;
import cn.iocoder.txgy.framework.common.util.object.BeanUtils;
import cn.iocoder.txgy.framework.common.util.object.ObjectUtils;
import cn.iocoder.txgy.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceAppealReqVO;
import cn.iocoder.txgy.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceConfirmReqVO;
import cn.iocoder.txgy.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceHandleStageReqVO;
import cn.iocoder.txgy.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceProcessRespVO;
import cn.iocoder.txgy.module.hrm.controller.admin.portal.performance.vo.task.HrmPortalPerformanceTaskPageReqVO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.employee.info.HrmEmployeeDO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentAppealRecordDO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentDO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentStageDO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO.HandlerStage;
import cn.iocoder.txgy.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO.ReviewStage;
import cn.iocoder.txgy.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentAppealRecordMapper;
import cn.iocoder.txgy.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentMapper;
import cn.iocoder.txgy.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentQuotaMapper;
import cn.iocoder.txgy.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentQuotaScoreMapper;
import cn.iocoder.txgy.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentStageMapper;
import cn.iocoder.txgy.module.hrm.enums.MessageTemplateConstants;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAppealStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAppealRecordStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAppealTimeoutActionEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentActionTypeEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentProcessStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentStageStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceConfirmationResultEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.plan.HrmPerformancePlanOperationTypeEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.plan.HrmPerformancePlanStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.plan.HrmPerformanceQuotaSettingTypeEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.plan.HrmPerformanceRaterTypeEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.assessment.HrmPerformanceResultAuditStatusEnum;
import cn.iocoder.txgy.module.hrm.enums.performance.plan.HrmPerformanceStageTypeEnum;
...
import cn.iocoder.txgy.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.iocoder.txgy.framework.common.util.collection.CollectionUtils.filterList;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_ASSESSMENT_NOT_EXISTS;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_DATA_ILLEGAL;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_PROCESS_CONFIG_INVALID;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_PROCESS_RUNNING_CANNOT_MODIFY;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_REVIEW_STAGE_CONFIG_INVALID;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_REVIEW_STAGE_NOT_EXISTS;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_ACTION_INVALID;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_HANDLER_USER_NOT_BOUND;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_NO_PERMISSION;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_TARGET_CONFIRM_CONFIG_INVALID;
import static cn.iocoder.txgy.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_TARGET_CONFIRM_NO_PERMISSION;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_HANDLE_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_HANDLE_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_TIMEOUT_HANDLE_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_TIMEOUT_HANDLE_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_RESULT_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_RESULT_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_TARGET_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_TARGET_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_RESULT_AUDIT_SUB_TYPE;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_RESULT_AUDIT_SUCCESS;
import static cn.iocoder.txgy.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_TYPE;
