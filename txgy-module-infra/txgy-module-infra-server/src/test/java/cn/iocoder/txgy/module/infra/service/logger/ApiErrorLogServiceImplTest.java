package cn.iocoder.txgy.module.infra.service.logger;
...
import cn.iocoder.txgy.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.iocoder.txgy.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.iocoder.txgy.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.iocoder.txgy.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.iocoder.txgy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.iocoder.txgy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("txgy-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("txgy-test");
