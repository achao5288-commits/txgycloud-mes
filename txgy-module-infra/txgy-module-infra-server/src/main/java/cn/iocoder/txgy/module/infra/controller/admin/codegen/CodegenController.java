package cn.iocoder.txgy.module.infra.controller.admin.codegen;
...
import cn.iocoder.txgy.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.iocoder.txgy.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.iocoder.txgy.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.iocoder.txgy.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.iocoder.txgy.module.infra.convert.codegen.CodegenConvert;
...
import cn.iocoder.txgy.module.infra.service.codegen.CodegenService;
...
import static cn.iocoder.txgy.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "txgy"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "OPENLAB BS")
    })
