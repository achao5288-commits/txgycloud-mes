...
import cn.iocoder.txgy.module.pay.enums.DictTypeConstants;
import cn.iocoder.txgy.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.iocoder.txgy.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.iocoder.txgy.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.iocoder.txgy.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.iocoder.txgy.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.iocoder.txgy.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.iocoder.txgy.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.iocoder.txgy.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.iocoder.txgy.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.iocoder.txgy.module.trade.controller.admin.order.vo.*;
import cn.iocoder.txgy.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.iocoder.txgy.module.trade.controller.app.order.vo.*;
import cn.iocoder.txgy.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.iocoder.txgy.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.iocoder.txgy.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.iocoder.txgy.module.trade.framework.order.config.TradeOrderProperties;
import cn.iocoder.txgy.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.iocoder.txgy.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/txgycode/txgy-mall-uniapp/issues/ICY7SJ
