package cn.iocoder.txgy.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    private Long spuId;
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
