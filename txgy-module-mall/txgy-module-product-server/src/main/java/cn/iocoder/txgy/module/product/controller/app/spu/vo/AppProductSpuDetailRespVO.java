package cn.iocoder.txgy.module.product.controller.app.spu.vo;

import cn.iocoder.txgy.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
    private String name;
