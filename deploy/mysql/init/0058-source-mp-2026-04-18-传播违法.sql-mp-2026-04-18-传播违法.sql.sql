...
CREATE TABLE `mp_auto_reply`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_app_id_type_request_message_type`(`app_id` ASC, `type` ASC, `request_message_type` ASC) USING BTREE,
  INDEX `idx_app_id_type_request_match_request_keyword`(`app_id` ASC, `type` ASC, `request_match` ASC, `request_keyword` ASC) USING BTREE,
...
CREATE TABLE `mp_material`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_account_id_media_id`(`account_id` ASC, `media_id` ASC) USING BTREE,
  INDEX `idx_account_id`(`account_id` ASC) USING BTREE,
...
CREATE TABLE `mp_user`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_app_id_openid`(`app_id` ASC, `openid` ASC) USING BTREE,
  INDEX `idx_account_id`(`account_id` ASC) USING BTREE
