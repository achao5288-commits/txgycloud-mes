...
-- ----------------------------
-- Table structure for service_fault_type
-- ----------------------------
DROP TABLE IF EXISTS `service_fault_type`;
CREATE TABLE `service_fault_type`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '故障类别id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '故障类型' ROW_FORMAT = DYNAMIC;
