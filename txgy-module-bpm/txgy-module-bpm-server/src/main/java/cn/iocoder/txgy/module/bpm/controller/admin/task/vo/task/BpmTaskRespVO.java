package cn.iocoder.txgy.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
    private String name;
    ...
    @Schema(description = "附件", example = "[https://test.txgy.iocoder.cn/20260609/test.txt]")
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
        private String name;
