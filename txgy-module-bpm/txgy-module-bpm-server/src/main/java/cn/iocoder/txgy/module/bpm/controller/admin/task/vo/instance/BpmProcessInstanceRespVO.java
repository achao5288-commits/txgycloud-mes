package cn.iocoder.txgy.module.bpm.controller.admin.task.vo.instance;
...
public class BpmProcessInstanceRespVO {
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
        private String name;
