package cn.iocoder.txgy.module.bpm.controller.admin.definition;
...
import cn.iocoder.txgy.module.bpm.controller.admin.definition.vo.model.*;
...
import cn.iocoder.txgy.module.bpm.service.definition.BpmCategoryService;
...
import static cn.iocoder.txgy.module.bpm.enums.ErrorCodeConstants.MODEL_IMPORT_FAIL_INVALID;
...
public class BpmModelController {
    ...
    @Parameters({
            ...
            @Parameter(name = "key", description = "流程标识，替换导入文件中的标识", example = "process_txgy"),
            @Parameter(name = "name", description = "流程名称，替换导入文件中的名称", example = "OPENLAB BS")
    })
