package cn.iocoder.txgy.module.bpm.service.task;
...
import cn.iocoder.txgy.framework.common.util.date.DateUtils;
...
import cn.iocoder.txgy.framework.datapermission.core.annotation.DataPermission;
import cn.iocoder.txgy.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.iocoder.txgy.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.iocoder.txgy.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.iocoder.txgy.module.bpm.controller.admin.task.vo.instance.*;
import cn.iocoder.txgy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.iocoder.txgy.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.iocoder.txgy.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.iocoder.txgy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.iocoder.txgy.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.iocoder.txgy.module.bpm.enums.ErrorCodeConstants;
import cn.iocoder.txgy.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.iocoder.txgy.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.iocoder.txgy.module.bpm.enums.task.BpmAttachmentTypeEnum;
import cn.iocoder.txgy.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.iocoder.txgy.module.bpm.enums.task.BpmReasonEnum;
import cn.iocoder.txgy.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.iocoder.txgy.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.iocoder.txgy.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.iocoder.txgy.module.bpm.service.message.BpmMessageService;
...
import static cn.iocoder.txgy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.iocoder.txgy.module.bpm.enums.ErrorCodeConstants.*;
import static cn.iocoder.txgy.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.iocoder.txgy.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/txgy-cloud/issues/ID1UYA
