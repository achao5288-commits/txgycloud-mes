...
import cn.iocoder.txgy.framework.test.core.util.AssertUtils;
import cn.iocoder.txgy.framework.test.core.util.RandomUtils;
import cn.iocoder.txgy.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import cn.iocoder.txgy.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.iocoder.txgy.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("OPENLAB BS")));
       // 测试 status 不匹配
