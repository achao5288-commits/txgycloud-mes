package cn.iocoder.txgy.module.mes.controller.admin.dv.repair;
...
import cn.iocoder.txgy.module.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import cn.iocoder.txgy.module.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody cn.iocoder.txgy.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
