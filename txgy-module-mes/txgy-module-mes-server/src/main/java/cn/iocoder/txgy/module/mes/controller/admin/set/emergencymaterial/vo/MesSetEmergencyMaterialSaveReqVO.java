...
@Schema(description = "管理后台 - MES 安全环保检测-应急物资 新增/修改 Request VO")
@Data
public class MesSetEmergencyMaterialSaveReqVO {

    @Schema(description = "编号", example = "1")
    private Long id;

    @Schema(description = "物资编号")
    @NotEmpty(message = "物资编号不能为空")
    ...
    @NotEmpty(message = "物资类型：DRY_SAND(干沙)/OIL_ABSORBENT(吸油毡)/CHEM_SUIT(防化服)/GAS_MASK(防毒面具)/EXPLOSION_TOOL(防爆工具)/SANDBAG(围堰沙袋)/EYE_WASH(洗眼器)/DRY_POWDER(干粉灭火器)不能为空")
