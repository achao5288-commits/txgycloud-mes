package cn.iocoder.txgy.module.mes.dal.dataobject.qc.ipqc;
...
import cn.iocoder.txgy.module.mes.dal.dataobject.qc.template.MesQcTemplateDO;
import cn.iocoder.txgy.module.mes.enums.qc.MesQcSourceDocTypeEnum;
...
public class MesQcIpqcDO extends BaseDO {
     ...
     * IPQC 检验类型
     *
     * 字典 {@link cn.iocoder.txgy.module.mes.enums.DictTypeConstants#MES_IPQC_TYPE}
     */
     ...
     *
     * 关联：根据 {@link #sourceDocType} 不同：
     * 1. {@link MesQcSourceDocTypeEnum#PRO_FEEDBACK} 时，关联 {@link cn.iocoder.txgy.module.mes.dal.dataobject.wm.productproduce.MesWmProductProduceLineDO#getId()}
     */
     ...
     * 生产任务 ID
     *
     * 关联 {@link cn.iocoder.txgy.module.mes.dal.dataobject.pro.task.MesProTaskDO#getId()}
     */
    private Long taskId;
    /**
     * 工位 ID
     ...
     * 工序 ID
     *
     * 关联 {@link cn.iocoder.txgy.module.mes.dal.dataobject.pro.process.MesProProcessDO#getId()}
     */
     ...
     * 枚举 {@link cn.iocoder.txgy.module.mes.enums.qc.MesQcCheckResultEnum}
     */
