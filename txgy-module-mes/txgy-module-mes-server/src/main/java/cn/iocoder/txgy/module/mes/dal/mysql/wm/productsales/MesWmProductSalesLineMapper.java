package cn.iocoder.txgy.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.iocoder.txgy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.iocoder.txgy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.iocoder.txgy.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
