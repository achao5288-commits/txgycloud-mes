package cn.iocoder.txgy.module.mes.controller.admin.wm.productsales;
...
import cn.iocoder.txgy.module.mes.controller.admin.wm.productsales.vo.detail.MesWmProductSalesDetailRespVO;
import cn.iocoder.txgy.module.mes.controller.admin.wm.productsales.vo.detail.MesWmProductSalesDetailSaveReqVO;
...
import cn.iocoder.txgy.module.mes.service.wm.productsales.MesWmProductSalesDetailService;
...
public class MesWmProductSalesDetailController {
    ...
    private List<MesWmProductSalesDetailRespVO> buildRespVOList(List<MesWmProductSalesDetailDO> list) {
        ...
        // 2. 构建结果
        List<MesWmProductSalesDetailRespVO> respList = BeanUtils.toBean(list, MesWmProductSalesDetailRespVO.class, vo -> {
        ...
        Map<Long, MesWmBatchDO> batchMap = CollectionUtils.convertMap(
                batchMapper.selectByIds(convertSet(list, MesWmProductSalesDetailDO::getBatchId)), MesWmBatchDO::getId);
