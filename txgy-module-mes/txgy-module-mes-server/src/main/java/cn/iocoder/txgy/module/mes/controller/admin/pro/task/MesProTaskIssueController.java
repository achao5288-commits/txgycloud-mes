package cn.iocoder.txgy.module.mes.controller.admin.pro.task;
...
import cn.iocoder.txgy.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.iocoder.txgy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.iocoder.txgy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.iocoder.txgy.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.iocoder.txgy.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
