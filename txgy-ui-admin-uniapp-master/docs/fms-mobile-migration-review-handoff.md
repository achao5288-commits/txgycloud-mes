...
> 仓库：`txgy-ui-admin-uniapp-next-v4`
> 对照 PC：`txgy-hrm-all/txgy-ui-admin-vue3/src/views/fms`
> 后端：`txgy-hrm-all/ruoyi-vue-pro-jdk25/txgy-module-fms`
...
- 账号：`admin` / `admin123`，`tenant-id: 1`；库里有多个已初始化账套（上海OPENLAB BS…、FMS回归测试账套…）和 3 张 2026-08 凭证
