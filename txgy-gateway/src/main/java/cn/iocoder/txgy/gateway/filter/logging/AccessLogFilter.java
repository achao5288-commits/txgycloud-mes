package cn.iocoder.txgy.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import cn.iocoder.txgy.framework.common.util.json.JsonUtils;
import cn.iocoder.txgy.gateway.util.SkyWalkingTraceUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 txgy-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
    ...
    private void writeAccessLog(ServerWebExchange exchange, AccessLog gatewayLog) {
        SkyWalkingTraceUtils.callWithTraceIdInMdc(exchange, () -> {
            ...
            try {
                ...
                // 兜底处理，参见 https://gitee.com/zhijiantianya/txgy-cloud/issues/IC9A70
