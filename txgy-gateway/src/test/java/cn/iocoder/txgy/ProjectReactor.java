...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "txgy";
    private static final String PACKAGE_NAME = "cn.iocoder.txgy";
    private static final String TITLE = "OPENLAB BS 管理系统";
