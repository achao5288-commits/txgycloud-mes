package cn.iocoder.txgy.module.crm.controller.admin.customer;
...
import cn.iocoder.txgy.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("OPENLAB BS").industryId(1).level(1).source(1)
