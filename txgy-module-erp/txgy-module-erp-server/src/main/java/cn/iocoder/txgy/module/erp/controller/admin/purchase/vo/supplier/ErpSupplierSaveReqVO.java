package cn.iocoder.txgy.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierSaveReqVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
