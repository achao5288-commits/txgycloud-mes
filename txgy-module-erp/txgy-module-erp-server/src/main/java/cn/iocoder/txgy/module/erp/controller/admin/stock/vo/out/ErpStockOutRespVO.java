package cn.iocoder.txgy.module.erp.controller.admin.stock.vo.out;
...
import static cn.iocoder.txgy.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "OPENLAB BS")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "OPENLAB BS")
    private String creator;
    @Schema(description = "创建人名称", example = "OPENLAB BS")
