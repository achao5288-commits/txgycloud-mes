package cn.iocoder.txgy.module.iot.gateway.protocol.emqx.handler.upstream;
...
import cn.iocoder.txgy.module.iot.gateway.protocol.emqx.IotEmqxProtocol;
    ...
    private void sendRegisterResultMessage(String username, IotDeviceRegisterRespDTO result) {
        ...
        try {
            ...
            byte[] encodedData = deviceMessageService.serializeDeviceMessage(responseMessage,
                    cn.iocoder.txgy.module.iot.core.enums.IotSerializeTypeEnum.JSON);
            // 1.3 构建响应主题
