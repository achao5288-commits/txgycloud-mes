package cn.iocoder.txgy.module.iot.gateway.config;

import cn.iocoder.txgy.module.iot.core.enums.IotProtocolTypeEnum;
import cn.iocoder.txgy.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.iocoder.txgy.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "txgy.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.iocoder.txgy.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.iocoder.txgy.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
