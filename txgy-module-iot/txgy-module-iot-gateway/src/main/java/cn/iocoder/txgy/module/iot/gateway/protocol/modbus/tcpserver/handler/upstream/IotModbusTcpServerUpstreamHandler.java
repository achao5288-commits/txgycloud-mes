package cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.iocoder.txgy.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.iocoder.txgy.framework.common.pojo.CommonResult;
import cn.iocoder.txgy.framework.common.util.json.JsonUtils;
import cn.iocoder.txgy.module.iot.core.biz.IotDeviceCommonApi;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.iocoder.txgy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.iocoder.txgy.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.iocoder.txgy.module.iot.core.mq.message.IotDeviceMessage;
import cn.iocoder.txgy.module.iot.core.topic.IotDeviceIdentity;
import cn.iocoder.txgy.module.iot.core.util.IotDeviceAuthUtils;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.iocoder.txgy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.iocoder.txgy.module.iot.gateway.service.device.IotDeviceService;
import cn.iocoder.txgy.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.iocoder.txgy.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.iocoder.txgy.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.iocoder.txgy.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.iocoder.txgy.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
