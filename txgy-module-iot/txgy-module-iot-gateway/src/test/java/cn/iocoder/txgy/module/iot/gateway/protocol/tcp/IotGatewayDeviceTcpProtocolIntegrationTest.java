...
import cn.iocoder.txgy.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import cn.iocoder.txgy.module.iot.core.util.IotDeviceAuthUtils;
import cn.iocoder.txgy.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
...
import cn.iocoder.txgy.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 txgy-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
