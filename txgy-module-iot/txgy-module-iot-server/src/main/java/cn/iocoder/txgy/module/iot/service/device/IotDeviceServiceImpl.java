package cn.iocoder.txgy.module.iot.service.device;
...
import cn.iocoder.txgy.framework.tenant.core.aop.TenantIgnore;
import cn.iocoder.txgy.framework.tenant.core.util.TenantUtils;
import cn.iocoder.txgy.module.iot.controller.admin.device.vo.device.*;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.iocoder.txgy.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import cn.iocoder.txgy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.iocoder.txgy.module.iot.core.enums.device.IotDeviceStateEnum;
...
import cn.iocoder.txgy.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import cn.iocoder.txgy.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import cn.iocoder.txgy.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import cn.iocoder.txgy.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import cn.iocoder.txgy.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import cn.iocoder.txgy.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import cn.iocoder.txgy.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import cn.iocoder.txgy.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import cn.iocoder.txgy.module.iot.core.util.IotDeviceAuthUtils;
import cn.iocoder.txgy.module.iot.core.util.IotProductAuthUtils;
import cn.iocoder.txgy.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.iocoder.txgy.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import cn.iocoder.txgy.module.iot.dal.dataobject.product.IotProductDO;
import cn.iocoder.txgy.module.iot.dal.mysql.device.IotDeviceMapper;
import cn.iocoder.txgy.module.iot.dal.redis.RedisKeyConstants;
import cn.iocoder.txgy.module.iot.enums.product.IotProductDeviceTypeEnum;
import cn.iocoder.txgy.module.iot.service.device.message.IotDeviceMessageService;
import cn.iocoder.txgy.module.iot.service.product.IotProductService;
...
import static cn.iocoder.txgy.module.iot.enums.ErrorCodeConstants.*;
