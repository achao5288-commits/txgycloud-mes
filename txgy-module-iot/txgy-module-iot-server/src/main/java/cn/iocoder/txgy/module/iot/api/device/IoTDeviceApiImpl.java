package cn.iocoder.txgy.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.iocoder.txgy.framework.common.enums.RpcConstants;
...
import cn.iocoder.txgy.module.iot.core.biz.dto.*;
...
import cn.iocoder.txgy.module.iot.dal.dataobject.device.IotDeviceModbusConfigDO;
import cn.iocoder.txgy.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import cn.iocoder.txgy.module.iot.dal.dataobject.product.IotProductDO;
import cn.iocoder.txgy.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 txgy-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
