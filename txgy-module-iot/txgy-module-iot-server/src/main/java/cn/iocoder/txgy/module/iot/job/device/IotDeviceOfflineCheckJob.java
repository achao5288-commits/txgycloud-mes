package cn.iocoder.txgy.module.iot.job.device;
...
import cn.iocoder.txgy.module.iot.framework.iot.config.TxgyIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private TxgyIotProperties iotProperties;
