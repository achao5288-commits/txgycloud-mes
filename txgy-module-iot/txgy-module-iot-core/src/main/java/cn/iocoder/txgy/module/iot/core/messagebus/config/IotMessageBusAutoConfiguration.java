package cn.iocoder.txgy.module.iot.core.messagebus.config;

import cn.iocoder.txgy.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.txgy.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.iocoder.txgy.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.iocoder.txgy.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.iocoder.txgy.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.iocoder.txgy.module.iot.core.messagebus.core.IotMessageBus;
import cn.iocoder.txgy.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import cn.iocoder.txgy.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.iocoder.txgy.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import cn.iocoder.txgy.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.iocoder.txgy.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "txgy.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "txgy.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "txgy.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 TxgyRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.txgy.framework.mq.redis.config.TxgyRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "txgy.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "txgy.iot.message-bus", name = "type", havingValue = "rabbitmq")
