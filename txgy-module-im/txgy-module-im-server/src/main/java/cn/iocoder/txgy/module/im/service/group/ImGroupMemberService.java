...
public interface ImGroupMemberService {
     ...
     * @param groupId 群编号
     * @param userId  用户编号
     * @param role    成员角色，见 {@link cn.iocoder.txgy.module.im.enums.group.ImGroupMemberRoleEnum}
     * @return 群成员记录
     */
    @SuppressWarnings("UnusedReturnValue")
     ...
     * @param userId        用户编号
     * @param role          成员角色
     * @param addSource     加入来源，见 {@link cn.iocoder.txgy.module.im.enums.group.ImGroupAddSourceEnum}
     ...
     * @param groupId 群编号
     * @param userIds 用户编号集合
     * @param role    新角色，见 {@link cn.iocoder.txgy.module.im.enums.group.ImGroupMemberRoleEnum}
     */
