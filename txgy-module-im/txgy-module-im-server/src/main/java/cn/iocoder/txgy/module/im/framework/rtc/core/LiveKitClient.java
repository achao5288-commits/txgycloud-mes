package cn.iocoder.txgy.module.im.framework.rtc.core;
 ...
 * <p>
 * 由 {@link cn.iocoder.txgy.module.im.framework.rtc.config.ImRtcConfiguration} 注册为 Bean，本类不带 {@code @Component}
 *
 * @author OPENLAB BS
 */
@Slf4j
