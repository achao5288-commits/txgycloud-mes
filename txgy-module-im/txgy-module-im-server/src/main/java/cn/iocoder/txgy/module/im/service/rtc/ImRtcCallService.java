...
public interface ImRtcCallService {
     ...
     */
    void handleLiveKitEvent(cn.iocoder.txgy.module.im.framework.rtc.core.LiveKitWebhookEventDTO event);
     ...
     * 实际超时阈值由后端 {@link cn.iocoder.txgy.module.im.framework.config.ImProperties.Rtc#getInviteTimeoutMinutes()} 决定，
