...
public interface ImGroupService {
     ...
     * @throws cn.iocoder.txgy.framework.common.exception.ServiceException 群已满抛 GROUP_MEMBER_EXCEED
     */
     ...
     * 获取指定用户的群列表
     * <p>
     * 返回用户当前仍有效的群，以及最近 txgy.im.message.group-pull-max-days 天内退群的群
     ...
     * 置顶群消息（仅群主或管理员可执行）
     * <p>
     * 上限由 txgy.im.group.pin-max-count 控制；幂等失败时抛业务异常
     *
     * @param userId    当前登录用户编号
     * @param groupId   群编号
