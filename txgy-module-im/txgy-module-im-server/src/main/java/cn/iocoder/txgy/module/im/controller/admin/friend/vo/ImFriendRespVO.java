package cn.iocoder.txgy.module.im.controller.admin.friend.vo;
...
public class ImFriendRespVO {
    ...
    @Schema(description = "好友昵称（实时聚合自 AdminUser）", example = "OPENLAB BS")
    private String nickname;

    @Schema(description = "好友昵称的拼音（小写无空格）", example = "txgy")
