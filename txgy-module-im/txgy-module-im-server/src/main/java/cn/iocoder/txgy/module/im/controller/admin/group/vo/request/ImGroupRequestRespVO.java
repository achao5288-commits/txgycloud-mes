package cn.iocoder.txgy.module.im.controller.admin.group.vo.request;
...
public class ImGroupRequestRespVO {
    ...
    @Schema(description = "申请人 / 被邀请人昵称（实时聚合自 AdminUser）", example = "OPENLAB BS")
    ...
    @Schema(description = "群名称（实时聚合自 ImGroup）", example = "OPENLAB BS技术交流群")
