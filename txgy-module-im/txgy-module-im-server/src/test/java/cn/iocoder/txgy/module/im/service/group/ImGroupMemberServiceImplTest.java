...
import cn.iocoder.txgy.module.im.controller.admin.group.vo.member.ImGroupMemberUpdateReqVO;
import cn.iocoder.txgy.module.im.dal.dataobject.group.ImGroupMemberDO;
import cn.iocoder.txgy.module.im.dal.mysql.group.ImGroupMemberMapper;
...
import static cn.iocoder.txgy.module.im.enums.ErrorCodeConstants.GROUP_MEMBER_NOT_IN_GROUP;
...
public class ImGroupMemberServiceImplTest extends BaseMockitoUnitTest {
    ...
    @Mock
    private cn.iocoder.txgy.module.im.service.message.ImGroupMessageService groupMessageService;
    ...
    public void testUpdateGroupMember_success() {
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), any(cn.iocoder.txgy.module.im.service.message.dto.ImGroupMessageSendDTO.class));
        // 个人字段 silent 变化 → 仅自己多端同步 GROUP_MEMBER_SETTING_UPDATE
        verify(groupMessageService).sendGroupMessage(eq(1L), eq(ListUtil.of(1L)),
                any(cn.iocoder.txgy.module.im.service.message.dto.ImGroupMessageSendDTO.class));
    }
