package cn.iocoder.txgy.module.mp.service.account;
...
import cn.iocoder.txgy.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.iocoder.txgy.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.iocoder.txgy.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.iocoder.txgy.module.mp.convert.account.MpAccountConvert;
import cn.iocoder.txgy.module.mp.dal.dataobject.account.MpAccountDO;
import cn.iocoder.txgy.module.mp.dal.mysql.account.MpAccountMapper;
import cn.iocoder.txgy.module.mp.enums.ErrorCodeConstants;
...
import static cn.iocoder.txgy.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 txgy-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
