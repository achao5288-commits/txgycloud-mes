package cn.iocoder.txgy.module.mp.service.message;
...
import cn.iocoder.txgy.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.iocoder.txgy.module.mp.convert.message.MpMessageConvert;
import cn.iocoder.txgy.module.mp.dal.dataobject.account.MpAccountDO;
import cn.iocoder.txgy.module.mp.dal.dataobject.message.MpMessageDO;
import cn.iocoder.txgy.module.mp.dal.dataobject.user.MpUserDO;
import cn.iocoder.txgy.module.mp.dal.mysql.message.MpMessageMapper;
import cn.iocoder.txgy.module.mp.enums.message.MpMessageSendFromEnum;
import cn.iocoder.txgy.module.mp.framework.mp.core.MpServiceFactory;
import cn.iocoder.txgy.module.mp.framework.mp.core.util.MpUtils;
import cn.iocoder.txgy.module.mp.service.account.MpAccountService;
import cn.iocoder.txgy.module.mp.service.material.MpMaterialService;
import cn.iocoder.txgy.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.iocoder.txgy.module.mp.service.user.MpUserService;
...
import static cn.iocoder.txgy.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
