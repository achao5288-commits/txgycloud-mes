package cn.iocoder.txgy.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
    @NotEmpty(message = "公众号名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "txgyyuanma")
    ...
    @Schema(description = "备注", example = "请关注OPENLAB BS，学习技术")
