package cn.iocoder.txgy.module.system.api.logger.dto;
...
public class OperateLogRespDTO implements VO {
    ...
    private Long userId;
    @Schema(description = "用户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
    ...
    @Schema(description = "操作内容", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从OPENLAB BS改成源码")
