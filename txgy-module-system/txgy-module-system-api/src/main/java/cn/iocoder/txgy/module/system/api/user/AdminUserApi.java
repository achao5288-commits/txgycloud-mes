...
import cn.iocoder.txgy.module.system.enums.ApiConstants;
...
import static cn.iocoder.txgy.module.system.api.user.AdminUserApi.PREFIX;
...
public interface AdminUserApi extends AutoTransable<AdminUserRespDTO> {
    ...
    @Parameter(name = "nickname", description = "昵称关键词", example = "OPENLAB BS", required = true)
