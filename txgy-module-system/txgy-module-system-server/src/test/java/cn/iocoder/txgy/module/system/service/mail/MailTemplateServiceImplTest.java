package cn.iocoder.txgy.module.system.service.mail;
...
import cn.iocoder.txgy.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
...
import cn.iocoder.txgy.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.iocoder.txgy.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("OPENLAB BS")));
        // 测试 code 不匹配
