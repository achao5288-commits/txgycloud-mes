package cn.iocoder.txgy.module.system.service.user;
...
import cn.iocoder.txgy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.txgy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.txgy.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.iocoder.txgy.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.iocoder.txgy.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.iocoder.txgy.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.iocoder.txgy.module.system.dal.dataobject.dept.DeptDO;
import cn.iocoder.txgy.module.system.dal.dataobject.dept.PostDO;
import cn.iocoder.txgy.module.system.dal.dataobject.dept.UserPostDO;
import cn.iocoder.txgy.module.system.dal.dataobject.tenant.TenantDO;
import cn.iocoder.txgy.module.system.dal.dataobject.user.AdminUserDO;
import cn.iocoder.txgy.module.system.dal.mysql.dept.UserPostMapper;
import cn.iocoder.txgy.module.system.dal.mysql.user.AdminUserMapper;
import cn.iocoder.txgy.module.system.enums.common.SexEnum;
import cn.iocoder.txgy.module.system.mq.producer.user.AdminUserProducer;
import cn.iocoder.txgy.module.system.service.dept.DeptService;
import cn.iocoder.txgy.module.system.service.dept.PostService;
import cn.iocoder.txgy.module.system.service.oauth2.OAuth2TokenService;
import cn.iocoder.txgy.module.system.service.permission.PermissionService;
import cn.iocoder.txgy.module.system.service.tenant.TenantService;
...
import static cn.iocoder.txgy.framework.common.util.collection.SetUtils.asSet;
import static cn.iocoder.txgy.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.iocoder.txgy.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.iocoder.txgy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.iocoder.txgy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.iocoder.txgy.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.iocoder.txgy.framework.test.core.util.RandomUtils.*;
import static cn.iocoder.txgy.module.system.enums.ErrorCodeConstants.*;
import static cn.iocoder.txgy.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("txgyyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("txgyyuanma");
        ...
        assertEquals("txgyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("txgyyuanma"))).thenReturn("java");
