package cn.iocoder.txgy.module.system.service.tenant;

import cn.iocoder.txgy.framework.common.enums.CommonStatusEnum;
import cn.iocoder.txgy.framework.common.pojo.PageResult;
import cn.iocoder.txgy.framework.tenant.config.TenantProperties;
import cn.iocoder.txgy.framework.tenant.core.context.TenantContextHolder;
import cn.iocoder.txgy.framework.test.core.ut.BaseDbUnitTest;
import cn.iocoder.txgy.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.iocoder.txgy.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.iocoder.txgy.module.system.dal.dataobject.permission.MenuDO;
import cn.iocoder.txgy.module.system.dal.dataobject.permission.RoleDO;
import cn.iocoder.txgy.module.system.dal.dataobject.tenant.TenantDO;
import cn.iocoder.txgy.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.iocoder.txgy.module.system.dal.mysql.tenant.TenantMapper;
import cn.iocoder.txgy.module.system.enums.permission.RoleCodeEnum;
import cn.iocoder.txgy.module.system.enums.permission.RoleTypeEnum;
import cn.iocoder.txgy.module.system.service.permission.MenuService;
import cn.iocoder.txgy.module.system.service.permission.PermissionService;
import cn.iocoder.txgy.module.system.service.permission.RoleService;
import cn.iocoder.txgy.module.system.service.tenant.handler.TenantInfoHandler;
import cn.iocoder.txgy.module.system.service.tenant.handler.TenantMenuHandler;
import cn.iocoder.txgy.module.system.service.user.AdminUserService;
...
import static cn.iocoder.txgy.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("OPENLAB BS", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("OPENLAB BS"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("OPENLAB BS");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
