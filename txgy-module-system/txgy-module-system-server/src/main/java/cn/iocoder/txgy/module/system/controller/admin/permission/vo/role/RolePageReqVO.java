package cn.iocoder.txgy.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "OPENLAB BS")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "txgy")
    private String code;
