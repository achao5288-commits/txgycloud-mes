package cn.iocoder.txgy.module.system.controller.admin.dict.vo.type;
...
public class DictTypeSimpleRespVO {
    ...
    @Schema(description = "字典类型名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
    private String name;
