...
import cn.iocoder.txgy.module.system.controller.admin.user.vo.user.*;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@iocoder.cn").mobile("15601691300")
                        .nickname("OPENLAB BS").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "OPENLAB BS")
