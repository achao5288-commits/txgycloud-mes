package cn.iocoder.txgy.module.system.service.social;
...
import cn.iocoder.txgy.framework.common.util.cache.CacheUtils;
import cn.iocoder.txgy.framework.common.util.http.HttpUtils;
import cn.iocoder.txgy.framework.common.util.object.BeanUtils;
import cn.iocoder.txgy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.txgy.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.iocoder.txgy.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.txgy.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.txgy.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.txgy.module.system.dal.mysql.social.SocialClientMapper;
import cn.iocoder.txgy.module.system.dal.redis.RedisKeyConstants;
import cn.iocoder.txgy.module.system.enums.social.SocialTypeEnum;
import cn.iocoder.txgy.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.iocoder.txgy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.txgy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${txgy.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${txgy.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/txgy-cloud/pulls/230
