package cn.iocoder.txgy.module.system.controller.admin.tenant.vo.tenant;
...
public class TenantSaveReqVO {
    ...
    @Schema(description = "租户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "OPENLAB BS")
