package cn.iocoder.txgy.module.wms.controller.admin.order.shipment.vo.order;
...
public class WmsShipmentOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "OPENLAB BS")
    ...
    @Schema(description = "更新者名称", example = "OPENLAB BS")
