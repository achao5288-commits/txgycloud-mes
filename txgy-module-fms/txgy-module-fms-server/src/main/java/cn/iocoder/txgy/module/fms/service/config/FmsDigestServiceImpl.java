...
import cn.iocoder.txgy.module.fms.controller.admin.config.vo.digest.FmsDigestSaveReqVO;
import cn.iocoder.txgy.module.fms.dal.dataobject.config.FmsDigestDO;
import cn.iocoder.txgy.module.fms.dal.mysql.config.FmsDigestMapper;
...
import static cn.iocoder.txgy.module.fms.enums.ErrorCodeConstants.DIGEST_NOT_EXISTS;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_CREATE_SUB_TYPE;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_CREATE_SUCCESS;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_DELETE_SUB_TYPE;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_DELETE_SUCCESS;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_TYPE;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_UPDATE_SUB_TYPE;
import static cn.iocoder.txgy.module.fms.enums.LogRecordConstants.FMS_DIGEST_UPDATE_SUCCESS;
