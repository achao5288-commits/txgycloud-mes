    ...
    <n-list bordered class="go-system-info">
      ...
      <n-list-item>
        <n-space class="go-my-2" :size="20">
          ...
          <n-text>
            对应 <n-a href="https://gitee.com/zhijiantianya/txgy-cloud" target="_blank">https://gitee.com/zhijiantianya/txgy-cloud</n-a> 项目
          </n-text>
        </n-space>
      </n-list-item>
      ...
      <n-list-item>
        <n-space class="go-my-2" :size="20">
          ...
          <n-text type="error">
            如下声明来自 GoView，和 ruoyi-vue-pro / txgy-cloud 项目无关，它们还是免费、免授权可使用！！！
          </n-text>
        </n-space>
      </n-list-item>
