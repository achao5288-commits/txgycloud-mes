package cn.iocoder.txgy.module.ai.framework.ai.core.model;
...
import cn.iocoder.txgy.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.iocoder.txgy.module.ai.framework.ai.config.TxgyAiProperties;
...
import cn.iocoder.txgy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.txgy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            TxgyAiProperties.Midjourney properties = SpringUtil.getBean(TxgyAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        TxgyAiProperties.YiYan properties = new TxgyAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        TxgyAiProperties.Grok properties = new TxgyAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
